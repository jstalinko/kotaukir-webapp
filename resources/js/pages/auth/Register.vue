        ...
        <Form v-bind="store.form()" :reset-on-success="['password', 'password_confirmation']"
            ...
            <div class="grid gap-6">
                <div class="grid gap-2">
                    <Label for="username">Sites</Label>
                    <div class="relative">
                        <Input id="username" v-model="username" type="text" required :tabindex="1"
                            autocomplete="username" name="username" placeholder="namabisnis" class="pr-28" />
                        <span
                            class="absolute right-3 top-1/2 -translate-y-1/2 text-sm text-muted-foreground font-medium pointer-events-none">
                            .kotaukir.id
                        </span>
                    </div>
                ...
                <div class="grid gap-2">
                    ...
                    <Input id="phone" type="tel" required :tabindex="2" autocomplete="phone" name="phone"
